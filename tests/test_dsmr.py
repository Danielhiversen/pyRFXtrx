...
class DsmrTestCase(TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(packet.databytes, b'')
    ...
    def test_header_data(self):
        ...
        self.assertEqual(packet.databytes, b'/XMX5LGBBLA4415570078')
    ...
    def test_version_data(self):
        ...
        self.assertEqual(packet.databytes, b'1-3:0.2.8(50)')
    ...
    def test_equipment_identifier(self):
        ...
        self.assertEqual(packet.databytes,
                         b'0-0:96.1.1(4530303436303034323138333239353138)')
    ...
    def test_checksum_data(self):
        ...
        self.assertEqual(packet.databytes, b'!DCD6')
