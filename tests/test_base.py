...
class CoreTestCase(TestCase):
    ...
    def test_format_packet(self):
        ...
        event = core.transport.parse(bytes_array)
        self.assertEqual(RFXtrx.SensorEvent, type(event))
        self.assertEqual(event.__str__(),"<class 'RFXtrx.SensorEvent'> device=[<class 'RFXtrx.RFXtrxDevice'> type='CARTELECTRONIC_LINKY' id='2a29f275'] values=[('Battery numeric', 9), ('Count', 0), ('Counter value', 0), ('Energy usage', 697), ('Rssi numeric', 6), ('Sensor Status', True), ('Total usage', 1674554), ('Voltage', 233)]")
        ...
        event = core.transport.parse(bytes_array)
        self.assertEqual(RFXtrx.ControlEvent, type(event))
        self.assertEqual(event.__str__(),"<class 'RFXtrx.ControlEvent'> device=[<class 'RFXtrx.ChimeDevice'> type='Byron SX' id='00:00'] values=[('Command', 'Sound 0'), ('Rssi numeric', 0), ('Sound', 0)]")
    ...
    def test_receive(self):
        ...
        self.assertEqual(event.__str__(),"<class 'RFXtrx.StatusEvent'> device=[<class 'RFXtrx.TransceiverDevice'> type='433.92MHz' id='None' firmware_version='69' firmware_type='Unknown None'] values=[('Devices', ['ac', 'arc', 'hideki', 'homeeasy', 'keeloq', 'lacrosse', 'oregon', 'rsl', 'x10']), ('Firmware Type', None), ('Firmware Version', 69), ('Hardware Version', '1.0')]")
        core.close_connection()
